...
import tomllib
def load_toml_creds():
    with open(file='$AIRFLOW_HOME/dags/.creds/dbcreds.toml', mode='rb') as f: 
        return tomllib.load(f)
import argparse
import os
parser = argparse.ArgumentParser(description="A script that greets a user and can use a verbose flag.")

parser.add_argument('--dbcreds', help='The name of the user to greet.')
parser.add_argument('--sql', help='The name of the user to greet.')
parser.add_argument('--output', help='The name of the user to greet.')
parser.add_argument('--file_format', help='The name of the user to greet.')
